...
public class Keys {
    ...
    public static final boolean HDMIRX_MANAGER_DEBUG_VERBOSE = G_DEBUG_FLAG | true;
    ...
    public static final String PROP_APK_MODE = "persist.vendor.rtk.hdmirx.apk.mode";

    /* Pure service mode */
    public static final String SERVICE_MODE = "service";
    /* Normal mode */
    public static final String ACTIVITY_MODE = "activity";

    public static int sPIPWinWidth = 1280/2;
    public static int sPIPWinHeight = 720/2;

    public static int sOffset = 50;

    public static int serviceModeX = 1920 - sPIPWinWidth - sOffset;
    public static int serviceModeY = 1080 - sPIPWinHeight - sOffset;

    public static int[] sServiceModeLocation = {serviceModeX,serviceModeY,sPIPWinWidth,sPIPWinHeight};
}
