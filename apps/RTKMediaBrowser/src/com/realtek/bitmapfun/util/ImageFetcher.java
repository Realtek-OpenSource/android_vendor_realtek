...
public class ImageFetcher extends ImageResizer {
    ...
    protected Bitmap processBitmap(byte[] data, int imageWidth, int imageHeight) {

		if(data !=null)
		{
			return decodeSampledBitmapFromByteArray(data, imageWidth, imageHeight);
		}	
		return null;
    }

    protected Bitmap processBitmap(Bitmap bitmap, int imageWidth, int imageHeight) {
    ...
    @Override
    protected Bitmap processBitmap(Object data, int type) {
		switch(type)
		{
			case OBJECT_TO_STRING:
				return processBitmap(String.valueOf(data));
			case OBJECT_TO_BYTEARRAY:
				return processBitmap((byte[])data, mImageWidth, mImageHeight);
			case OBJECT_TO_BITMAP:
				return processBitmap((Bitmap)data, mImageWidth, mImageHeight);
			default:
				return processBitmap(String.valueOf(data));
		}
    }
