...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private String[] BitrateMode = {"Variable", "Constant", "VariableSkipFrames", "ConstantSkipFrames"};
