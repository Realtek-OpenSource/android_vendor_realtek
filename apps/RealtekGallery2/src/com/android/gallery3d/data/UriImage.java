        ...
        if (ContentResolver.SCHEME_CONTENT.equals(scheme)
            ...
            try {
                if (MIME_TYPE_JPEG.equalsIgnoreCase(mContentType) ||
                    mUri.toString().toLowerCase().endsWith("jpeg") || mUri.toString().toLowerCase().endsWith("jpg") ||
                    mUri.toString().toLowerCase().endsWith("heic") || mUri.toString().toLowerCase().endsWith("heif")) {
