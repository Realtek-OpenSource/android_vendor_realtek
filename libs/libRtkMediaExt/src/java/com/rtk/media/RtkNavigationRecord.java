 ...
 *
 */
public final class RtkNavigationRecord {
    ...
    /* package private */ RtkNavigationRecord(Map<String, Object> map) {
        mMap = map;
    }
     ...
     */
    public static final RtkNavigationRecord createNavigationRecord(
            int domain,
            int numOfTitles,
            int numOfChapters,
            int numOfAngles) {
        RtkNavigationRecord record = new RtkNavigationRecord();
