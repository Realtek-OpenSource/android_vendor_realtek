...
public class FloatingWindowViewGroup3 /*implements RtkHDMIRxManager.HDMIRxListener*/ {
    ...
    public void acquireWakeLock(Context c){
        if(mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "HDMIRx.ViewGroup");
            mWakeLock.acquire();
        }else{
    ...
    public boolean startRecord(Bundle arg) {
        ...
        */
        ...
        int extension = arg.getInt(Keys.KEY_OUTPUT_FORMAT,Keys.FORMAT_MP4);
    ...
    private void attachRecordInfoView(){
        if(mRecordInfoView != null) {
            int flag = FloatingWindowView.FLOATING_WINDOW_FULL_SCREEN_FLAG|
