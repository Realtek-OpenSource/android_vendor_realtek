...
public class FloatingWindowService2 extends Service {
    ...
    private static final String TAG = "HDMIRxFloatingWindowService2";

    public static final int FLOATING_WINDOW_TYPE = WindowManager.LayoutParams.TYPE_SYSTEM_ERROR;
    ...
    private int[] mServiceModeLocation = Keys.sServiceModeLocation;
    ...
    public void acquireWakeLock(){
        if(mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "HDMIRxDemo.Record");
            mWakeLock.acquire();
        }else{
    ...
    private void createFloatingWindowEx3(int winId, Bundle arg){
        ...
        int flag;
        int fullscreenflag = FloatingWindowView.FLOATING_WINDOW_FULL_SCREEN_FLAG;
        if(touchable) {
            flag = fullscreenflag|
    ...
    public static int[] getServiceModeLocation() {
        if(mInstance==null) return null;
        return mInstance.mServiceModeLocation;
    }
