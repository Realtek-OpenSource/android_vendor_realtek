 ...
 */
public final class RtkMediaType {
    ...
    /* package private */ RtkMediaType(Map<String, Object> map) {
        mMap = map;
    }
     ...
     */
    public static final RtkMediaType createMediaType(
            int majorType,
            int subType) {
        RtkMediaType type = new RtkMediaType();
