...
public class ImageResizer extends ImageWorker {
    ...
    public static synchronized Bitmap decodeSampledBitmapFromByteArray(byte[] data,
        ...
        // First decode with inJustDecodeBounds=true to check dimensions
        final BitmapFactory.Options options = calculateImageSize(data);
    ...
    public static synchronized Bitmap decode(String path,BitmapFactory.Options options, int reqWidth, int reqHeight)
	{
    	...
    	try
    	{
            ...
            if(path.toLowerCase().endsWith("jpeg") || path.toLowerCase().endsWith("jpg") ||
                path.toLowerCase().endsWith("heic") || path.toLowerCase().endsWith("heif"))
            {
    ...
    public static BitmapFactory.Options calculateImageSize(byte[] data) {
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
