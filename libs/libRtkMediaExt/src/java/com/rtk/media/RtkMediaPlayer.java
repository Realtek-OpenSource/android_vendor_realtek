...
import com.rtk.media.ext.RtkMediaFormat;
// end of RTK
...
public class RtkMediaPlayer extends MediaPlayer
{
    /**
    ...
    static {
        System.loadLibrary("rtk-mediaplayer_jni");
    }

    private final static String TAG = "RtkMediaPlayer_JAVA";
    // Name of the remote interface for the media player. Must be kept
    // in sync with the 2nd parameter of the IMPLEMENT_META_INTERFACE
    // macro invocation in IMediaPlayer.cpp
    private final static String IMEDIA_PLAYER = "com.rtk.media.ext.RtkMediaPlayer";
...
*/
    ...
    private boolean mFromMusic = false;
/*
...
//                AudioPlaybackConfiguration.PLAYER_TYPE_JAM_MEDIAPLAYER);
        ...
        postEventFromRtkNative(null, MEDIA_NOP, 0, 0, null);
        native_init();
    ...
    public RtkMediaPlayer(int useRTMediaPlayer) {
        if(useRTMediaPlayer==FORCE_BY_SCORE) {
            mFromMusic = true;
        }
    }
    ...
    // added by RTK
    private static final int INVOKE_ID_SET_TV_SYSTEM_TYPE = 1001;
    private static final int INVOKE_ID_SET_LANGUAGES = 1002;
    private static final int INVOKE_ID_SET_GET_NAV_PROPERTY = 1003;
    private static final int INVOKE_ID_EXEC_BOOKMARK_OPERATION = 1004;
    private static final int INVOKE_ID_EXEC_SUBTITLE_OPERATION = 1005;
    private static final int INVOKE_ID_EXEC_AUDIO_OPERATION = 1006;
    private static final int INVOKE_ID_SET_VIDEO_SCALED_SIZE = 1007;
    // end of RTK
     ...
     */
    public static RtkMediaPlayer create(Context context, Uri uri) {
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static RtkMediaPlayer create(Context context, Uri uri, SurfaceHolder holder) {
    ...
    public static RtkMediaPlayer create(Context context, Uri uri, SurfaceHolder holder,
        ...
        try {
            RtkMediaPlayer mp = new RtkMediaPlayer();
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static RtkMediaPlayer create(Context context, int resid) {
        int s = AudioSystem.newAudioSessionId();
...
/*
    ...
    /* package */
/*
	@Nullable VolumeShaper.State playerGetVolumeShaperState(int id) {
...
*/
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode|PowerManager.ON_AFTER_RELEASE, RtkMediaPlayer.class.getName());
...
///////////// added by RTK  ////////////////////////////////////
    ...
    */
    ...
    static public class NaviInfo implements Parcelable {
         ...
         */
        public RtkNavigationRecord getRecord() {
            return mRecord;
        }

        final RtkNavigationRecord mRecord;
        ...
        NaviInfo(Parcel in) {
            ...
            mRecord = RtkNavigationRecord.createNavigationRecord(
                        domain, numOfTitles, numOfChapters, numOfAngles);
            if (numOfField == 7) {
                mRecord.setInteger(RtkNavigationRecord.KEY_CURRENT_TITLE, in.readInt());
                mRecord.setInteger(RtkNavigationRecord.KEY_CURRENT_CHAPTER, in.readInt());
                mRecord.setInteger(RtkNavigationRecord.KEY_CURRENT_ANGLE, in.readInt());
            }
            Log.d(TAG, "got navigation record: " + mRecord.toString());
        }

        /** @hide */
        NaviInfo(RtkNavigationRecord record) {
            mRecord = record;
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_DOMAIN));
            dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_NUM_OF_TITLES));
            dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_NUM_OF_CHAPTERS));
            dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_NUM_OF_ANGLES));
            if (numOfFields == 7) {
                dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_CURRENT_TITLE));
                dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_CURRENT_CHAPTER));
                dest.writeInt(mRecord.getInteger(RtkNavigationRecord.KEY_CURRENT_ANGLE));
            }
        }
...
//            Log.d(TAG, "got BD info(): " + mList.toString());
    ...
    static public class NaviType implements Parcelable {
        /** @hide */
        public RtkMediaType getType() {
            return mType;
        }

        final RtkMediaType mType;

        NaviType(Parcel in) {
            int numOfField = in.readInt();
            int majorType = in.readInt();
            int subType = in.readInt();
            mType = RtkMediaType.createMediaType(majorType, subType);
            Log.d(TAG, "got navigation type: " + mType.toString());
        }

        /** @hide */
        NaviType(RtkMediaType type) {
            mType = type;
        }
    ...
    */
    public MediaPlayer.TrackInfo[] getAudioTrackInfo(boolean bForceUpdate) throws IllegalStateException {
        Parcel request = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        try {
    ...
    * getSubtitleTrack: get all the subtitle tracks
    */
    public MediaPlayer.TrackInfo[] getSubtitleTrackInfo(boolean bForceUpdate) throws IllegalStateException {
        Parcel request = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        try {
            ...
            if (mTrackType == MEDIA_TRACK_TYPE_SUBTITLE) {
                ...
                */
                ...
                if (numOfField == 6) {  //RTMediaPlayer
                    ...
                    mFormat.setInteger(RtkMediaFormat.KEY_SPU_FROM, from);
                    mFormat.setInteger(RtkMediaFormat.KEY_SPU_TYPE, type);
                ...
                if (numOfField == 10) { //RTMediaPlayer
                    ...
                    mFormat.setInteger(RtkMediaFormat.KEY_IS_PROGRESSIVE, in.readInt());
                    mFormat.setInteger(RtkMediaFormat.KEY_IS_MVC, in.readInt());
                    mFormat.setInteger(RtkMediaFormat.KEY_IS_HDR, in.readInt());
                    ...
                    mFormat.setString(MediaFormat.KEY_MIME, type);
                    mFormat.setString(MediaFormat.KEY_LANGUAGE, language);
                    Log.d(TAG, "got MEDIA_TRACK_TYPE_VIDEO("+numOfField+"): " + mFormat.toString() + ", type: " + type);
                }
        ...
        if ((mSubtitleController == null) && (ActivityThread.currentApplication() != null)) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mSubtitleController = new SubtitleController(context, mTimeProvider, RtkMediaPlayer.this);
...
//        baseRelease();
    ...
    {
        private RtkMediaPlayer mMediaPlayer;

        public EventHandler(RtkMediaPlayer mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
...
*/
     ...
     */
    private static void postEventFromRtkNative(Object mediaplayer_ref,
                                            int what, int arg1, int arg2, Object obj)
    {
        ...
        final RtkMediaPlayer mp = (RtkMediaPlayer)((WeakReference)mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
...
//    }
    ...
    */
     ...
     * @hide
     */
    public static final int MEDIA_INFO_DOMAIN_UPDATE = 2001;

    /** The DVD title is changed
     * @hide
     */
    public static final int MEDIA_INFO_TITLE_UPDATE = 2002;

    /** The DVD chapter is changed
     * @hide
     */
    public static final int MEDIA_INFO_CHAPTER_UPDATE = 2003;

    /** Audio occurs fatal error
     * @hide
     */
    public static final int MEDIA_INFO_AUDIO_FATAL_ERROR = 2004;
...
/*
    ...
    private class ProvisioningThread extends Thread
    {
        ...
        private RtkMediaPlayer mediaPlayer;
        private int status;
        ...
        public ProvisioningThread initialize(MediaDrm.ProvisionRequest request,
                                          UUID uuid, RtkMediaPlayer mediaPlayer) {
