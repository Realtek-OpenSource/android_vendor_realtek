...
class ISidebandClient : public IInterface
{
    public:
        ...
        virtual status_t    requestHwSyncByFd(int32_t* resource, int audioHwSync) = 0;
        ...
        virtual status_t    getSidebandInfo(const sp<IBinder>& handle, String8 &info) = 0;
        virtual status_t    setHackSideband(const sp<IBinder>& handle, bool use) = 0;
        virtual status_t    controlBW(void) = 0;
};
