...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private Button btnRecDemo = null;
    ...
    private CheckBox chbTimbar = null;
...
//    private String[] Source = {"U-Disk", "Samba", "HDMI-Rx", "USB-Camera"};
    private String[] Source = {"U-Disk", "HDMI-Rx"};
...
//    private SmbUtils smbUtils = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRecDemo = (Button) findViewById(R.id.btnRecDemo);
        ...
        chbTimbar = (CheckBox) findViewById(R.id.chbTimbar);
...
//        SmbUtils.deleteInstance();
    ...
    public void onClick(View v) {
        if(v instanceof AutoCompleteTextView){
            ...
            if(chbTimbar.isChecked())
                intent.putExtra("TIMBAR", 1);
            else
                intent.putExtra("TIMBAR", 0);
