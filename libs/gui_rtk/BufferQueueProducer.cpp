...
#ifdef RTK_FRAMEEORK_FLOW
        mCore->freeAllBuffersLocked();
        mCore->mBufferHasBeenQueued = false;
#endif /* end of RTK_FRAMEEORK_FLOW */
...
status_t BufferQueueProducer::getLastQueuedBuffer(sp<GraphicBuffer>* outBuffer,
    ...
    *outFence = mLastQueueBufferFence;
    ...
    computeTransformMatrix(outTransformMatrix,
...
void BufferQueueProducer::computeTransformMatrix(float outTransform[16],
