...
public class GalleryUtils {
    ...
    public static String[] getPlayListFromFile(Context ctx, String playListAddress) {
        Uri fileUri = Uri.parse(playListAddress);
        ArrayList<String> playlist = new ArrayList<String>();
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(ctx.getContentResolver().openInputStream(fileUri)) );
            String line;
    ...
    public static boolean hasSubtitlePlayListFromFile(Context ctx, String playListAddress) {
        boolean ret = false;
