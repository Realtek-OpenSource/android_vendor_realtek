...
public class MyReceiver extends BroadcastReceiver {
    ...
    public static final String TOGGLE_PIP_BC = "android.intent.action.TOGGLE_PIP";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        }else if(action.equals(TOGGLE_PIP_BC)) {
            if(isServiceMode()) {
                if(FloatingWindowService2.bServiceIsAlive) {
                    FloatingWindowViewGroup3 vg3 = FloatingWindowService2.getViewGroupControl();
                    if(vg3 != null) {
                        if(vg3.mFloatingView != null) {
                            vg3.mFloatingView.toggleFullScreen();
                        }
                    }
                }
            }
