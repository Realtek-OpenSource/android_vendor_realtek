...
public class RtkTVSystem implements Parcelable {
    ...
    public static final int VO_HDR_CTRL_NONE = 0;   // depreciated
    ...
    public static final int VO_HDR_CTRL_CURRENT = 0xf0;
    public static final int VO_HDR_CTRL_FACTORY = 0xf1;
